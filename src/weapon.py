...
class Bullet(Weapon):
    ...
    def __init__(self, sprite: Sprite|None = None, velocity_x: int = cfg.physics.enemy_bullet_velocity, **kwargs):
        if sprite is None: sprite = Sprite(im.weapons.bullet, animation_time=5)
        super().__init__(sprite=sprite, velocity_x=velocity_x, **kwargs)

class Bomb(Weapon):
    """A Weapon that represents a bomb"""
    def __init__(self, sprite: Sprite|None = None, velocity_x: int = 5, velocity_y: int = 0, drag_multiplier: float = 0.1, **kwargs):
        ...
        super().__init__(sprite=sprite, velocity_x=velocity_x, velocity_y=velocity_y + cfg.physics.bomb_y_velocity_gain, **kwargs)
...
class Rocket(Weapon):
    ...
    def __init__(self, sprite: Sprite|None = None, velocity_x: int = 0, velocity_y: int = 0, drag_multiplier: float = 0.1, **kwargs):
